  ...
  return `
        <div class="p-6 space-y-6">
            <div class="glass-card p-6 rounded-xl bg-gradient-to-r from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20">
                ...
                <p class="text-emerald-700 dark:text-emerald-400 mt-2">Mode: ${role}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="glass-card p-4 rounded-lg text-center">
                    ...
                    <p class="text-3xl font-bold text-emerald-600 dark:text-emerald-400 mt-2">42</p>
                </div>
                <div class="glass-card p-4 rounded-lg text-center">
        ...
        <div class="p-6 max-w-2xl">
            <div class="glass-card p-6 rounded-lg">
                ...
                <form class="space-y-4" onsubmit="event.preventDefault(); window.showToast('Form submission akan diimplementasikan', 'info');">
                    ...
                    <button type="submit" class="w-full p-3 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-lg transition-colors">
                        Kirim Setor
                    </button>
                </form>
            </div>
